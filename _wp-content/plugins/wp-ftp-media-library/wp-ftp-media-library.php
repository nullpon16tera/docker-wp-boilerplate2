...
function wpse_74180_upload_to_ftp( $args ) {
	...
	$settings = array(
		'host'	  =>	's153.coreserver.jp',  			// * the ftp-server hostname
		'port'    =>    21,                                 // * the ftp-server port (of type int)
		'user'	  =>	'mirai', 				// * ftp-user
		'pass'	  =>	'JuwDqtgM2key',	 				// * ftp-password
		'cdn'     =>    'cdn.mi-rai.work',			// * This have to be a pointed domain or subdomain to the root of the uploads
		'path'	  =>	'/public_html/cdn.mi-rai.work',	 					// - ftp-path, default is root (/). Change here and add the dir on the ftp-server,
